          ...
          children: [
            ...List.generate(
              ...
              ((index) {
                ...
                //* when we on index 2 , add spacer widget => we add more widget
                //? to our list, so add one into list lenght
                //! also our items orders index it different?
                //* if it less than 2 index == index
                //* if 2 or more we should -1 from it
                //* because we add spacer widget to list item
                return index == 2
                    ? const Spacer()
                    : CustomButtonAppBar(
